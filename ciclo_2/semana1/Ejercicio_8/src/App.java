...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        // Obtener el número entero digitado en la consola
        int numero = sc.nextInt();

        // Impresión del resultado llamando la función numeroDoble
        System.out.println("El número doble de " + numero + " es: " + numeroDoble(numero));
        // Impresión del resultado llamando la función numeroTriple
